...
``animators`` and a collection of main modules (presets) for each
...
The main module is a pipeline, on the flowchart a 3-wheel robot. It
...
Everything is packed together in the ``compute_closed_loop_rhs`` for the use in
``Simulator``.
...
This will call the pipeline with default settings, description of which
can be found in the pipeline accordingly.
...
+-------------------------+-----------+--------------------------------------------------------+
| ``prediction_horizon``              | integer   | Horizon length (in steps) for predictive controllers   |
+-------------------------+-----------+--------------------------------------------------------+
| ``running_obj_struct``    | string    | Structure of running objective function                |
+-------------------------+-----------+--------------------------------------------------------+
| ``Ncritic``             | integer   | Critic stack size (number of TDs)                      |
+-------------------------+-----------+--------------------------------------------------------+
| ``discount_factor``               | number    | Discount factor                                        |
+-------------------------+-----------+--------------------------------------------------------+
...
-  `More on "STAG", joint actor-critic
