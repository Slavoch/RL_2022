...
class Actor:
    ...
    def forward(self, weights_actor, observation):
        # REDUNDANT?

        weights_actor_reshaped = rc.reshape(
            weights_actor, (self.dim_input, self.dim_actor_per_input)
        )

        result = self.model(weights_actor_reshaped, observation, observation)
